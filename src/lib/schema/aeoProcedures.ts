...
export const getAeoProceduresSchemaGraph = (faqs?: FaqItem[]) => {
  const graphNodes: any[] = [
    {
      "@type": "WebPage",
      "@id": "https://www.aeobility.com.au/services/aeo/procedures#webpage",
      ...
      "breadcrumb": {
        "@id": "https://www.aeobility.com.au/services/aeo/procedures#breadcrumb"
      },
      "mainEntity": {
        "@id": "https://www.aeobility.com.au/services/aeo/procedures#howto"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 4,
          "name": "AEO Procedures",
          "item": "https://www.aeobility.com.au/services/aeo/procedures"
        }
      ]
    },
    {
      ...
      "step": [
        {
          ...
          "url": "https://www.aeobility.com.au/services/aeo/procedures#strategy1"
        },
        {
          "@type": "HowToStep",
          "position": 2,
          ...
          "url": "https://www.aeobility.com.au/services/aeo/procedures#strategy2"
        },
        {
          "@type": "HowToStep",
          "position": 3,
          ...
          "url": "https://www.aeobility.com.au/services/aeo/procedures#strategy3"
        }
      ]
    }
  ];
  ...
  if (faqs && faqs.length > 0) {
    graphNodes.push({
      "@type": "FAQPage",
      "@id": "https://www.aeobility.com.au/services/aeo/procedures#faq-procedures",
