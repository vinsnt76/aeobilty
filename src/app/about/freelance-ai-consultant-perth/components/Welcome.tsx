...
import { ArrowRight, Cpu, Network, Bot, Zap } from 'lucide-react';
    ...
    <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-12 overflow-hidden bg-white dark:bg-[#0a0a0a] text-neutral-900 dark:text-neutral-100 transition-colors duration-300">
      ...
      <div className="container relative mx-auto px-6 max-w-5xl flex flex-col items-center text-center z-10">
        ...
        >
          ...
          Independent AI Agent & Workflow Engineer • Perth, WA
        </motion.div>
        ...
        <motion.p 
          ...
          className="text-lg md:text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mb-12 leading-relaxed"
        >
          I replace repetitive manual tasks with self-healing n8n pipelines, orchestrate secure API integrations, and build custom AI agents that actually move business metrics, not just generate text.
        </motion.p>

        {/* Proof Points Grid (AI/Automation focus) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="p-4 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl border border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center text-center">
            <Network className="w-6 h-6 text-aeo-cyan mb-2" />
            <span className="text-xl md:text-2xl font-bold text-neutral-900 dark:text-white mb-1">n8n</span>
            <span className="text-xs text-neutral-500 dark:text-neutral-400">Workflow Automation</span>
          </div>
          <div className="p-4 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl border border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center text-center">
            <Zap className="w-6 h-6 text-aeo-cyan mb-2" />
            <span className="text-xl md:text-2xl font-bold text-neutral-900 dark:text-white mb-1">API</span>
            <span className="text-xs text-neutral-500 dark:text-neutral-400">Custom Orchestration</span>
          </div>
          <div className="p-4 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl border border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center text-center">
            <Cpu className="w-6 h-6 text-aeo-cyan mb-2" />
            <span className="text-xl md:text-2xl font-bold text-neutral-900 dark:text-white mb-1">LLMs</span>
            <span className="text-xs text-neutral-500 dark:text-neutral-400">Graph Prompting</span>
          </div>
          <div className="p-4 bg-neutral-50 dark:bg-neutral-900/50 rounded-xl border border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center text-center">
            <Bot className="w-6 h-6 text-aeo-cyan mb-2" />
            <span className="text-xl md:text-2xl font-bold text-neutral-900 dark:text-white mb-1">Bots</span>
            <span className="text-xs text-neutral-500 dark:text-neutral-400">Voice & Text Agents</span>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            <span className="relative z-10">Book an Automation Discovery Session</span>
