      ...
      >
          ...
          >
            ...
            <div className="space-y-12 pl-8 md:pl-0"> 
              {timelineItems.map((step, index) => (
                ...
                >
                  <div className="hidden md:flex w-8 h-8 rounded-full bg-aeo-cyan border-4 border-white dark:border-neutral-900 absolute -left-4 top-0 items-center justify-center"> {/* Adjusted left */}
                    <step.icon size={18} className="text-white" />
                  </div>
                  <div className="flex-1 md:ml-8"> {/* Add margin to content */}
                    <h4 className="text-xl font-semibold text-aeo-cyan">{step.period}</h4>
        ...
        >
          <button
            ...
            className="bg-gradient-to-r from-aeo-cyan to-aeo-purple text-black px-10 py-4 rounded-full font-bold text-lg shadow-xl shadow-aeo-cyan/20 hover:scale-[1.02] transition-all duration-300"
          >
            See My Impact
          </button>
        </motion.div>
