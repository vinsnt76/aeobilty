          ...
          <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl sticky top-24">
            ...
            <nav className="flex flex-col gap-3 text-xs sm:text-sm">
              ...
              <div className="flex flex-col gap-1 ml-8 pl-3 border-l border-white/10 text-xs">
                <Link href="#dense-retrieval-llm" className="text-white/50 hover:text-aeo-cyan transition-colors py-0.5">
                  &bull; Dense Retrieval &amp; LLM
                </Link>
                ...
                <Link href="#common-mistakes" className="text-white/50 hover:text-aeo-cyan transition-colors py-0.5">
                  &bull; Common Mistakes
                </Link>
