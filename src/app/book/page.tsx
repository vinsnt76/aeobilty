...
export const metadata: Metadata = {
  ...
  description: "Book a complimentary 15-minute clarity call with an AEObility specialist to review your AI search visibility, answer engine roadmap, and growth strategy.",
  alternates: {
