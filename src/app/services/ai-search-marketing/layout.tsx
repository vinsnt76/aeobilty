...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.aeobility.com.au/services/ai-search-marketing",
  },
  openGraph: {
    title: "AI Search Marketing & Strategy | AEObility",
    ...
    images: [
      {
        url: "https://www.aeobility.com.au/images/services/ai-search-marketing-strategy_AEObility.webp",
        width: 1200,
        height: 800,
  ...
  twitter: {
    ...
    title: "AI Search Marketing & Strategy | AEObility",
    description: "Make your business easier for search engines, digital assistants and AI search platforms to identify, understand, and reference.",
    images: ["https://www.aeobility.com.au/images/services/ai-search-marketing-strategy_AEObility.webp"],
  },
  keywords: [
    "ai search marketing",
    "ai search strategy",
