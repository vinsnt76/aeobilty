...
export const LOCAL_BUSINESS_INTERNAL_LINKS = [
  {
    targetSlug: "/services/geo-marketing",
    anchorText: "GEO Marketing Services Hub",
...
export default function LocalBusinessAEOPage() {
  ...
  const handleDiagnosticSubmit = (e: React.FormEvent) => {
    ...
    trackGaEvent('generate_lead', {
      ...
      form_id: 'local_business_diagnostic_form',
      lead_type: 'local_visibility_scan',
      value: 1,
    });
    setDiagnosticSubmitted(true);
    setTimeout(() => {
      setDiagnosticSubmitted(false);
      setDiagnosticData({ businessName: '', websiteUrl: '', email: '' });
    }, 6000);
  };
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    ...
    trackGaEvent('generate_lead', {
      event_category: 'lead_generation',
      form_id: 'local_business_contact_form',
  ...
  const faqs = [
    {
      question: "What is included in a $495 Business Details & Citation Clean-Up Micro-Sprint?",
      answer: "This sprint covers reviewing and correcting your core NAP (Name, Address, Phone number) details across priority local directories, your website footer, and Google Business Profile. We fix inconsistent location data so search systems can confirm your business information with confidence."
    },
    {
      question: "How long does a Local Business AEO sprint take to deliver?",
      answer: "Most targeted Micro-Sprints are delivered within 4–5 business days after scope and access are confirmed. More complex multi-location requirements are scoped separately."
    },
    {
      question: "What is the difference between Local SEO and Local AEO?",
      answer: "Local SEO focuses on optimizing your website and Google Business Profile for map pack rankings. Local AEO restructures your location signals, service categories, and verified credentials so digital assistants and AI search engines (like ChatGPT, Gemini, and Apple Maps) can accurately recommend your business."
    },
    {
    ...
    {
      question: "Do you require ongoing monthly retainers or locked-in contracts?",
      answer: "No. AEObility local sprints are fixed-scope, flat-rate engagements. No ongoing retainer or monthly contract is required."
    },
    {
      question: "What access is required to begin a local business sprint?",
      answer: "Depending on the agreed scope, we may require website CMS access, Google Business Profile management access, or details of active local directory listings. We confirm all access requirements before work begins."
    }
  ];

  const engagementPaths = [
    {
      key: "citation-clean-up",
      anchorId: "local-citation-sprint",
      icon: <Building2 className="w-6 h-6 text-aeo-purple" />,
      title: "Business Details & Citation Clean-Up",
      code: "SS4MICRO1",
      price: "$495 AUD",
      priceSub: "ex. GST",
      scope: "Core NAP & Directory Consistency",
      description: "Review and correct your business name, address, phone number, and core category signals across priority Australian directories and Google Business Profile.",
      techNote: "For technical teams: Standardise Schema.org LocalBusiness properties and NAP data across external citation sources.",
      whenToChoose: "Choose this when inconsistent address, name or phone details across directories are weakening local map trust.",
      ctaLabel: "Discuss Citation Clean-Up"
    },
    {
      key: "local-internal-linking",
      anchorId: "local-linking-sprint",
      icon: <MapPin className="w-6 h-6 text-aeo-cyan" />,
      title: "Local Proximity & Internal Linking",
      code: "SS3MICRO1",
      price: "$695 AUD",
      priceSub: "ex. GST",
      scope: "Location Hubs & Service Page Linking",
      description: "Connect priority location hubs, service pages, and supporting regional content with a clear internal linking lattice designed for regional search discovery.",
      techNote: "For technical teams: Implement structured contextual internal linking arrays connecting location nodes to core service pages.",
      whenToChoose: "Choose this when your business serves multiple local areas but lacks clear site connections between services and locations.",
      ctaLabel: "Discuss Local Linking Sprint"
    },
    {
      key: "foundation",
      ...
      priceSub: "ex. GST",
      scope: "Connected improvements across priority local pages",
      description: "Combine agreed improvements across LocalBusiness schema, Google Business Profile alignment, internal linking, and atomic service page rewrites in one four-week engagement.",
      techNote: "For technical teams: Multi-location schema graphs, local landing page refactoring, and citation alignment.",
      whenToChoose: "Choose this when your local business needs connected improvements across website structure, directory consistency, and service pages.",
        ...
        <div className="max-w-5xl mx-auto px-6 space-y-16">
          ...
          <section id="hero" className="text-center max-w-4xl mx-auto space-y-6 scroll-mt-24">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-aeo-cyan font-medium">
              ...
              <span>Local Business Visibility &amp; Proximity Sprints</span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-tight font-soehne-breit">
              Local Business Visibility: <span className="text-gradient-aeo">Maps &amp; AI Search</span>
            </h1>
            <div className="space-y-3 max-w-2xl mx-auto">
              <h2 className="text-base sm:text-lg text-white/90 font-medium leading-relaxed font-soehne-breit">
                Improve how clearly your Perth or Australian business is represented across Search, Google Business Profile, Maps, local directories, and AI search engines. Clear scope. Flat rates.
              </h2>
            ...
            <div className="relative w-full max-w-3xl mx-auto rounded-2xl overflow-hidden border border-cyan-500/30 shadow-[0_0_30px_rgba(6,182,212,0.2)] my-8 group min-h-[360px] sm:min-h-[420px]">
              <Image
                ...
                alt="AEObility local business visibility interface displaying Google Business Profile optimisation, local citation alignment, and map pack tracking in Perth WA."
                width={1200}
                height={800}
              ...
              <div className="absolute bottom-3 sm:bottom-6 inset-x-3 sm:inset-x-6 z-20 p-3.5 sm:p-6 rounded-2xl bg-zinc-950/90 border border-white/15 backdrop-blur-md flex flex-col md:flex-row items-stretch sm:items-center justify-between gap-3 shadow-2xl">
                <div className="text-left space-y-0.5 sm:space-y-1">
                  <span className="text-[11px] sm:text-xs font-mono text-cyan-300 font-bold block uppercase tracking-wider">Fix one local visibility issue or build a stronger local foundation.</span>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full sm:w-auto shrink-0">
                  <button
                    type="button"
                    onClick={() => selectSprintForForm('citation-clean-up')}
                  ...
                  >
                    ...
                    <span>Discuss your local business</span>
                  </button>
                  <a
            ...
            <p className="text-xs text-zinc-400 font-serif">
              Built for trades, clinics, and professional services in Perth and Western Australia. Explore our <Link href="/services/geo-marketing" className="text-cyan-400 hover:underline font-medium">GEO Marketing Services Hub</Link>.
            </p>
          </section>
          ...
          <section id="engagement-paths" className="border-t border-white/10 pt-16 space-y-8 scroll-mt-24">
            ...
            <div id="local-comparison" className="overflow-x-auto rounded-xl border border-white/10 bg-zinc-950/80 shadow-md scroll-mt-24">
              <table className="w-full text-left text-xs font-serif border-collapse min-w-[580px]">
                ...
                <tbody className="divide-y divide-white/5 text-zinc-300">
                  <tr className="hover:bg-white/[0.02] transition">
                    <td className="p-3.5 sm:p-4 font-bold text-white font-sans">Citation Clean-Up Sprint</td>
                    <td className="p-3.5 sm:p-4">NAP &amp; Core Directory Consistency</td>
                    <td className="p-3.5 sm:p-4">Inconsistent business address or phone data</td>
                    <td className="p-3.5 sm:p-4 text-right font-mono font-bold text-cyan-300">$495 AUD</td>
                  </tr>
                  <tr className="hover:bg-white/[0.02] transition">
                    <td className="p-3.5 sm:p-4 font-bold text-white font-sans">Local Internal Linking Sprint</td>
                    <td className="p-3.5 sm:p-4">Location Hubs &amp; Service Page Linking</td>
                    <td className="p-3.5 sm:p-4">Connecting regional content to service pages</td>
                    <td className="p-3.5 sm:p-4 text-right font-mono font-bold text-cyan-300">$695 AUD</td>
                  </tr>
                  <tr className="hover:bg-white/[0.02] transition">
                  ...
                  <tr className="hover:bg-white/[0.02] transition">
                    ...
                    <td className="p-3.5 sm:p-4">Multi-Page &amp; Connected Local Fixes</td>
                    <td className="p-3.5 sm:p-4">Connected improvements across entire business</td>
            ...
            <div className="bg-cyan-950/20 border border-cyan-500/30 rounded-xl p-5 text-xs text-zinc-300 font-serif leading-relaxed space-y-3 shadow-sm">
              ...
              <ul className="space-y-2 text-xs text-zinc-300 font-serif">
                <li className="flex items-start gap-2">
                  ...
                  <span>One agreed local priority, specified citation clean-up, or internal linking work.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-cyan-400 shrink-0 mt-0.5" />
            ...
            <div className="max-w-3xl mx-auto bg-zinc-950/90 border border-cyan-500/30 p-6 sm:p-10 rounded-2xl shadow-2xl relative overflow-hidden backdrop-blur-md">
              ...
              <div className="text-center space-y-3 mb-8">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-950/60 border border-cyan-500/30 text-cyan-300 text-xs font-mono font-bold">
                  ...
                  <span>Instant Local Visibility Scan</span>
                </div>
                ...
                <p className="text-xs sm:text-sm text-zinc-400 font-serif max-w-xl mx-auto leading-relaxed">
                  Enter your business details below to check map pack signals, NAP consistency, and local AEO readiness.
                </p>
              </div>
              ...
              {diagnosticSubmitted ? (
                <div className="p-6 bg-cyan-950/40 border border-cyan-500/30 rounded-xl text-center space-y-3 animate-fade-in">
                  ...
                  <p className="text-xs text-zinc-300 font-serif leading-relaxed">
                    Thank you. Our AEObility local search team will audit your business details and send your gap report within 24 business hours.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleDiagnosticSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-12 gap-4">
                    {/* Business Name Field - Col Span 12 on Mobile, Col Span 6 on Desktop */}
                    <div className="col-span-12 md:col-span-6 space-y-1.5">
                      <label className="block text-xs font-semibold text-zinc-300" htmlFor="local-diag-bname">
                        Business Name
                      </label>
                      <input
                        type="text"
                        id="local-diag-bname"
                        required
                        value={diagnosticData.businessName}
                        onChange={(e) => setDiagnosticData({ ...diagnosticData, businessName: e.target.value })}
                        ...
                        placeholder="e.g. Apex Electrical Perth"
                      />
                    </div>

                    {/* Website URL Field - Col Span 12 on Mobile, Col Span 6 on Desktop */}
                    <div className="col-span-12 md:col-span-6 space-y-1.5">
                    ...
                    {/* Primary Email Field - Col Span 12 */}
                    <div className="col-span-12 space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-black/60 border border-white/15 rounded-xl px-4 py-3 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-cyan-400 transition-colors"
                        placeholder="admin@apexelectrical.com.au"
                      />
                      <p className="text-[11px] text-zinc-400 font-serif leading-tight">
                        We check local directory consistency, Google Business Profile signals, and location page structure for common visibility gaps.
                      </p>
                    </div>

                    <div className="col-span-12">
                      <p className="text-[11px] text-zinc-400 font-serif leading-tight">
                        We use your details to deliver your local visibility score and gap report. We will not add you to marketing communications without your consent.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-2">
                    ...
                    >
                      <span>Run Free Local Visibility Scan</span>
          ...
          <section id="local-process" className="border-t border-white/10 pt-16 space-y-8 scroll-mt-24">
            <div className="text-center max-w-2xl mx-auto space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white font-soehne-breit">How Local Business Sprints Work</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="p-6 bg-zinc-950/90 border border-white/10 rounded-2xl space-y-3 relative hover:border-cyan-500/40 transition">
                ...
                <h3 className="text-base font-bold text-white font-soehne-breit">Local Scan &amp; Access</h3>
                <p className="text-xs text-zinc-300 font-serif leading-relaxed">Run a free scan or confirm your business location scope and directory access.</p>
              </div>
              ...
              <div className="p-6 bg-zinc-950/90 border border-white/10 rounded-2xl space-y-3 relative hover:border-purple-500/40 transition">
                ...
                <p className="text-xs text-zinc-300 font-serif leading-relaxed">Deploy agreed citation fixes, LocalBusiness schema, or location page linking.</p>
              </div>
          ...
          <section id="local-contact-form" className="border-t border-white/10 pt-16 text-center space-y-8 scroll-mt-24">
            <div className="max-w-md mx-auto space-y-4">
              <h2 className="text-3xl font-bold text-white font-soehne-breit">Send Local Business Enquiry</h2>
              <p className="text-sm text-zinc-400 leading-relaxed font-serif">
                Tell us about your local business and location priorities. We will confirm scope and pricing before you commit. <Link href="/contact" className="text-cyan-400 hover:underline font-medium">Request a quote</Link>.
              </p>
            ...
            <div className="max-w-xl mx-auto bg-zinc-950/90 border border-white/10 p-6 sm:p-8 rounded-2xl text-left shadow-2xl relative overflow-hidden backdrop-blur-md">
              ...
              <div className="flex items-center justify-between gap-4 mb-1.5">
                <h3 className="text-xl font-bold text-white font-soehne-breit">Discuss Local Business Visibility</h3>
              ...
              {contactSubmitted ? (
                <div className="p-6 bg-cyan-950/40 border border-cyan-500/30 rounded-xl text-center space-y-3 animate-fade-in">
                  <CheckCircle2 className="w-10 h-10 text-cyan-400 mx-auto" />
                  <h4 className="font-bold text-white text-base">Local Business Enquiry Received</h4>
                  <p className="text-xs text-zinc-300 font-serif leading-relaxed">
                    Thank you for reaching out. Our AEObility local team will review your details and get in touch within 24 business hours.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="citation-clean-up">Citation Clean-Up Sprint ($495 AUD)</option>
                      <option value="local-internal-linking">Local Internal Linking Sprint ($695 AUD)</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="For example: fixing inconsistent directory citations, Google Business Profile alignment, or location page linking..."
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full group flex items-center justify-center gap-2 py-4 px-6 rounded-xl bg-gradient-to-r from-aeo-cyan to-aeo-purple text-black font-bold text-sm hover:opacity-95 transition-all shadow-[0_0_20px_rgba(0,205,216,0.25)] cursor-pointer"
                  >
                    <span>Discuss Local Business Visibility</span>
                    <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                  </button>
          ...
          <section id="faq-local" className="border-t border-white/10 pt-16 space-y-8 scroll-mt-24">
            <div className="text-center max-w-2xl mx-auto space-y-2">
              ...
              <p className="text-xs text-white/60 font-serif">Everything you need to know about AEObility local business visibility sprints.</p>
            </div>
