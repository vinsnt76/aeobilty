...
export const metadata = {
  ...
  alternates: {
    canonical: "https://aeobility.com.au/services/aeo/eligibility-and-constraints",
  },
};
...
export default function AEOConstraintsPage() {
  const schema = {
    ...
    "@type": "FAQPage",
    "@id": "https://aeobility.com.au/services/aeo/eligibility-and-constraints#faq",
    "mainEntity": [
      {
        "@type": "Question",
        ...
        <aside className="lg:col-span-4 flex flex-col gap-6">
          <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/services/aeo/eligibility-and-constraints" className="text-sm font-semibold text-aeo-cyan transition-colors bg-white/5 py-2 px-3 rounded-lg">
        ...
        <section className="lg:col-span-8 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="border border-white/5 rounded-2xl overflow-hidden bg-white/[0.01] divide-y divide-white/5">
              <div className="p-6">
                <h3 className="font-semibold text-sm sm:text-base text-white/95 mb-2">Can a small website benefit from AEO services?</h3>
              ...
              <div className="p-6">
                <h3 className="font-semibold text-sm sm:text-base text-white/95 mb-2">What are the primary risks of not optimizing for AEO in 2026?</h3>
                <p className="text-xs sm:text-sm text-white/60 leading-relaxed">
