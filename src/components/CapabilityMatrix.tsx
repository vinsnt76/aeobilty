...
export default function CapabilityMatrix() {
  return (
    <section 
      ...
      // 1. Declare this section as an explicit ItemList of Capabilities provided by AEObility
      itemScope 
        ...
        <table className="w-full text-left border-collapse bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <tbody className="text-sm text-slate-700 divide-y divide-slate-100">
            ...
            <tr itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              ...
              <td className="p-4">
                <a itemProp="url" href="https://aeobility.com.au/api/mcp" className="text-blue-600 font-mono text-xs hover:underline">/api/mcp</a>
              </td>
            ...
            <tr itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              ...
              <td className="p-4">
                <a itemProp="url" href="https://aeobility.com.au/api/search/answer" className="text-blue-600 font-mono text-xs hover:underline">/api/search/answer</a>
              </td>
            ...
            <tr itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              ...
              <td className="p-4">
                <a itemProp="url" href="https://aeobility.com.au/api/chat" className="text-blue-600 font-mono text-xs hover:underline">/api/chat</a>
              </td>
            ...
            <tr itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              ...
              <td className="p-4 text-xs font-mono text-slate-500">
                <a itemProp="url" href="https://aeobility.com.au" className="text-blue-600 font-mono text-xs hover:underline">HTML Head Index</a>
              </td>
            ...
            <tr itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              ...
              <td className="p-4">
                <a itemProp="url" href="https://aeobility.com.au/robots.txt" className="text-blue-600 font-mono text-xs hover:underline">/robots.txt</a>
              </td>
